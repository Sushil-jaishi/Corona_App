...
class PrivacyPolicy extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          Text('Burgeon Tech built the Nep Quarantines app as an Ad Supported app. This SERVICE is provided by Burgeon Tech at no cost and is intended for use as is.'),
          ...
          Text('The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Nep Quarantines unless otherwise defined in this Privacy Policy.'),
          Text('Information Collection and Use',style: TextStyle(fontWeight: FontWeight.bold),),
          Text('For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to name, phone number, email, location. The information that we request will be retained by us and used as described in this privacy policy.'),
          ...
          Center(child: Text('Google Play Services',style: TextStyle(color: Colors.blue),)),
          Center(child: Text('AdMob',style: TextStyle(color: Colors.blue),),),
          ...
          Text('If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at contact.burgeon@gmail.com.'),
